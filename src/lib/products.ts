...
export const FIT_MODES: { id: FitMode; label: string; note: string; noteWithBleed: string }[] = [
  {
    id: 'cover',
    label: 'そのまま印刷',
    note: '裁断後、ふちがわずかに白く残る可能性があります。白く残らないように印刷するには「塗り足し・トンボ作成」オプションを検討してください。',
    noteWithBleed: '「塗り足し・トンボ作成」オプションで、ふちまでキレイに仕上げます。',
  },
  {
    id: 'contain',
    label: '全体を入れる（周りに余白）',
    note: '絵柄が一切切れません。かわりに上下または左右に余白が入ります。',
    noteWithBleed: '絵柄が一切切れません。上下または左右の余白ごと、塗り足しを付けて仕上げます。',
  },
];
